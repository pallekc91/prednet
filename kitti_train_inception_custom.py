...
from prednet_inception_custom import PredNetInceptionCustom
...
prednet_inception_custom = PredNetInceptionCustom(channels_a, channels_r, glob_filter_size, return_sequences=True)
